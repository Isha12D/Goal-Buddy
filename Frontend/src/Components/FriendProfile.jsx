...
const FriendProfile = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:3006/goals/top-winners')
      .then((res) => {
      ...
      //fetch user rank
      axios.get(`http://localhost:3006/rank/${currentUser._id}`)
    ...
    axios.get(`http://localhost:3006/completed-goals/${currentUser._id}`)
